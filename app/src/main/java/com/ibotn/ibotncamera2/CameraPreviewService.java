...
import com.ibotn.ibotncamera2.utils.GlUtil;
    ...
    public Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == MESSAGE_TAKE_PICTURE) {
                ...
                if (!isTheActivityRunning(CameraPreviewService.this, "com.ibotn.ibotncamera.CameraVideoActivity")) {
                    eventsHandler = null;
                    stopVideoRecording();
                }
            }
...
//			stopVoiceCommand();
    ...
    private void stopVoiceCommand() {
        Intent intent = new Intent("com.ibotn.ibotncamera.ACTION_VOICECOMMAND");//(Utils.ACTION_VOICECOMMAND);
